...
main_title = Label(window,
                   text="Text PC : Builder",
                   bg="black",
                   fg="white",
                   font="Krungthep 55",
                   anchor="center")
...
def intro():
    ...
    continue_below = Button(window,
                           text="✓",
                            command=start_sequence)

    continue_below.place(relx=0.5,
                        rely=0.34,
                        anchor="center")
...
def build_tutorial():
    ...
    finish_tutorial = Button(window,
                            text="---> CLICK HERE TO START!",
                             relief="solid",
                             borderwidth=40,
                             command=to_frame_create)

    finish_tutorial.place(relx=0.93,
                    rely=0.02,
                    anchor="center")

    tutorial_exists_label = Label(window,
                                  text="Tutorial:",
                                  bg="black",
                                  fg="white",
                                  font="Krungthep 37",
    ...
    tutorial_exists_label.place(relx=0.1,
                          rely=0.02,
                          anchor="center")
    ...
    def build():
        ...
        case_5 = Part("Darkflash DLM21 Mesh", 65, 9)
        ...
        motherboard_6 = Part("MSI MEG X570 ACE", 510, 9.3)
        ...
        cpu_5 = Part("AMD Ryzen 3 3300X", 239, 5.1)
        ...
        gpu_5 = Part("Nvidia GeForce GTX 1660 Super", 329, 7.6)
        ...
        storage_5 = Part("Samsung 860 Pro", 218, 7.4)
        ...
        cooling_6 = Part("CoolerMaster MasterLiquid ML360R RGB", 190, 8.6)
        ...
        power_7 = Part("NZXT E650.", 210, 7.3)
        ...
        def case():
            ...
            CaseList = [
                ...
                case_6.name + " ||$" + str(case_6.price) + " ||⭑ " + str(case_6.rating),
            ...
            case_opt = OptionMenu(window, CaseVariable, *CaseList)
            ...
            def callback(*args):
                select_case_label.configure(text="Case Selected: {}".format(CaseVariable.get()))
                ...
                case_5_str = case_5.name + " ||$" + str(case_5.price) + " ||⭑ " + str(case_5.rating)
        ...
        def motherboard():
            ...
            def cpu():
                ...
                global previous_part_motherboard
                ...
                cpuList = [
                    ...
                    cpu_8.name + " ||$" + str(cpu_8.price) + " ||⭑ " + str(cpu_8.rating),
            ...
            def gpu():
                ...
                def callback(*args):
                    selectgpu_label.configure(text="GPU Selected: {}".format(gpuVariable.get()))
            ...
            def ram():
                ...
                ram_opt = OptionMenu(window, ramVariable, *ramList)
                ...
                def callback(*args):
                    ...
                    ram_5_str = ram_5.name + " ||$" + str(ram_5.price) + " ||⭑ " + str(ram_5.rating)
            ...
            def storage():
                ...
                storage_opt = OptionMenu(window, storageVariable, *storageList)
                ...
                storage_selected_label.pack(side=TOP, anchor="nw")
                ...
                def callback(*args):
                    ...
                    if storage_select == storage_1_str:
                        storage_price = 684
                    if storage_select == storage_2_str:
                        storage_price = 239
            ...
            def cooling():
                ...
                def callback(*args):
                    ...
                    cooling_1_str = cooling_1.name + " ||$" + str(cooling_1.price) + " ||⭑ " + str(cooling_1.rating)
                    ...
                    if cooling_select == cooling_8_str:
                        cooling_price = 219
                    if cooling_select == cooling_9_str:
                        cooling_price = 145
            ...
            def power():
                ...
                powerList = [
                    ...
                    power_4.name + " ||$" + str(power_4.price) + " ||⭑ " + str(power_4.rating),
                ...
                def callback(*args):
                    ...
                    power_6_str = power_6.name + " ||$" + str(power_6.price) + " ||⭑ " + str(power_6.rating)
                ...
                next_part_finish = Button(window,
                                          text="✓",
            ...
            def finish():
                pc_price = case_price+motherboard_price+cpu_price+gpu_price+ram_price+storage_price+power_price+cooling_price
                ...
                pc_image = PhotoImage(file="img/pc.png")
                ...
                if case_price == 1:
                    ...
                    box_image = PhotoImage(file="img/box.png")
                ...
                def open_paste():
                    webbrowser.open('https://pastebin.com/571ZpPFn')
